...
# Decision tree
model = DecisionTreeRegressor(random_state=42)  # Use DecisionTreeRegressor
model.fit(X_train, y_train)

y_pred = model.predict(X_test) #테스트데이터로 모델 평가
...
top_10_locations.to_excel('../data/top_10_locations_decision_tree.xlsx', index=False)
